...
window.onload = function() {
    ...
    //looping to create a figure, adding the image inside the figure with its alt and then adding a caption
    images.forEach(function(image){
        ...
        var caption = document.createElement('figcaption'); //adding the figure's caption
